...
class CampaignController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $uploadpath1 = 'assets/uploads/campaign/';
        ...
        if($image2){
            ...
            $uploadpath2 = 'assets/uploads/campaign/';
        ...
        if($image3){
            ...
            $uploadpath3 = 'assets/uploads/campaign/';
     ...
     // image four
        ...
        if($image4){
            ...
            $uploadpath4 = 'assets/uploads/campaign/';
    ...
    // image five
        ...
        if($image5){
            ...
            $uploadpath5 = 'assets/uploads/campaign/';
        ...
        if($images){
            foreach ($images as $key => $image) {
                ...
                $uploadPath = 'assets/uploads/campaign/';
	...
	// image five
        ...
        if($image_five){
            ...
            $name5 = preg_replace('"\.(jpg|jpeg|png|webp)$"', '.webp',$name5);
            $name5 = strtolower(preg_replace('/\s+/', '-', $name5));
            $uploadpath45 = 'assets/uploads/campaign/';
