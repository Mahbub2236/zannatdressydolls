                    ...
                    <form action="{{ route('customer.ordersave') }}" method="POST" data-parsley-validate="">
                        ...
                        <div class="card">
                           <div class="card-header">
                                <h6>আপনার অর্ডারটি কনফার্ম করতে তথ্যগুলো পূরণ করে <span style="color:#682237;">"অর্ডার করুন"</span> বাটন এ ক্লিক করুন অথবা ফোনে অর্ডার করতে এই নাম্বার <a href="tel:88{{$contact->hotline}}" style="color:#682237;">{{$contact->hotline}}</a> এর উপরে ক্লিক করুন।   </h6>
...
<script src="{{ asset('assets/frontEnd/') }}/js/form-validation.init.js"></script>
