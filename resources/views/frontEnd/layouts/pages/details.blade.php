...
@push('css')
<link rel="stylesheet" href="{{ asset('assets/frontEnd/css/zoomsl.css') }}">
@endpush
                                                                    ...
                                                                    @foreach ($productcolors as $procolor)
                                                                        <div class="selector-item">
                                                                            ...
                                                                            <label for="fc-option{{ $procolor->id }}"
                                                                                ...
                                                                                <span>
                                                                                    <img src="{{ asset('assets/frontEnd/images') }}/check-icon.svg"
                                                                                        alt="Checked Icon" />
                                                                                </span>
                                                                            </label>
                                                                        </div>
...
<script src="{{ asset('assets/frontEnd/js/zoomsl.min.js') }}"></script>
