...
<html lang="en">
    <head>
        ...
        <meta name="author" content="Bohisojja" />
        ...
        <link rel="stylesheet" href="{{asset('assets/frontEnd/css/mobile-menu.css')}}" />
        <link rel="stylesheet" href="{{asset('assets/frontEnd/css/select2.min.css')}}" />
        <!-- toastr css -->
        <link rel="stylesheet" href="{{asset('assets/backEnd/')}}/assets/css/toastr.min.css" />

        <link rel="stylesheet" href="{{asset('assets/frontEnd/css/wsit-menu.css')}}" />
        <link rel="stylesheet" href="{{asset('assets/frontEnd/css/style.css')}}" />
        <link rel="stylesheet" href="{{asset('assets/frontEnd/css/responsive.css')}}" />
        <link rel="stylesheet" href="{{asset('assets/frontEnd/css/main.css')}}" />

        <!-- ===== Theme fonts: "Malancha" Premium Boutique Theme ===== -->
        <link rel="preconnect" href="https://fonts.googleapis.com" />
        <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin />
        <link href="https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,500;0,600;0,700;1,400&family=Hind+Siliguri:wght@300;400;500;600;700&family=Montserrat:wght@400;500;600;700&display=swap" rel="stylesheet" />
        
        <style>
    /* =====================================================================
       "মালঞ্চ" (Malancha) PREMIUM BOUTIQUE THEME - FIXED & REFINED
       ===================================================================== */

    :root {
      --malancha-plum:       #4A1525;   /* Deep Regal Plum */
      --malancha-plum-dark:  #310B17;   /* Footer/Header background */
      --malancha-plum-soft:  #682237;   /* Hover state */
      --malancha-gold:       #D4AF37;   /* Metallic Gold */
      --malancha-rosegold:   #E0A899;   /* Rose Gold Motif */
      --malancha-cream:      #FAF6F0;   /* Ivory Background */
      --malancha-card:       #FFFFFF;   /* White Surfaces */
      --malancha-mauve:      #F4EBEB;   /* Soft Mauve */
      --malancha-ink:        #2D1F22;   /* Main Text */
      --malancha-ink-muted:  #756366;   
      
      --radius-premium: 12px;
      --radius-smooth:  8px;
      --radius-pill:    50px;
      
      --premium-shadow: 0 4px 20px rgba(74, 21, 37, 0.05);
      --premium-hover-shadow: 0 12px 30px rgba(74, 21, 37, 0.12);
    }

    /* Base Styling */
    body {
      background: var(--malancha-cream) !important;
      color: var(--malancha-ink) !important;
      font-family: 'Hind Siliguri', 'Montserrat', sans-serif !important;
    }

    /* Fixed Orange Elements to Match Theme */
    .main-search button, .mobile-search button {
      background: var(--malancha-plum) !important;
      color: var(--malancha-rosegold) !important;
    }
    .main-search button:hover {
      background: var(--malancha-gold) !important;
      color: var(--malancha-plum-dark) !important;
    }
    .main-search input, #searchbox {
      border: 1.5px solid var(--malancha-rosegold) !important;
    }
    ...
    .section-title-name {
      ...
      font-weight: 700;
      font-size: 28px;
      color: var(--malancha-plum);
    }
    .sec_title .section-title-header::after {
      content: "";
      display: block;
      width: 80px;
      height: 2px;
      margin: 10px auto 0;
      background: var(--malancha-gold);
    }

    /* Circle Category Custom Border Fix */
    .cat_img {
      border-radius: 50% !important;
      border: 2px solid var(--malancha-rosegold) !important;
      overflow: hidden;
    ...
    /* Premium Product Card Fixes */
    .product_item {
      background: var(--malancha-card) !important;
      border: 1px solid rgba(224, 168, 153, 0.2) !important;
    ...
    .product_item:hover {
      ...
      border-color: var(--malancha-rosegold) !important;
    }
    ...
    .pro_price p {
      color: var(--malancha-plum) !important;
      font-weight: 700 !important;
      font-size: 16px !important;
    }
    .pro_price del {
      color: var(--malancha-ink-muted) !important;
      font-size: 13px !important;
    }

    /* Fixed Buttons (No more Orange/Messy Borders) */
    .pro_btn {
      padding: 0 10px 15px !important;
    }
    .pro_btn form button, .pro_btn .addcartbutton, .pro_btn button {
      background: linear-gradient(135deg, var(--malancha-plum) 0%, var(--malancha-plum-soft) 100%) !important;
      color: #fff !important;
      border: none !important;
    ...
    .pro_btn form button:hover, .pro_btn .addcartbutton:hover, .pro_btn button:hover {
      background: var(--malancha-gold) !important;
      color: var(--malancha-plum-dark) !important;
      box-shadow: 0 4px 15px rgba(212, 175, 55, 0.3);
    }

    /* Global View More Button Fix (Orange to Luxury Plum) */
    .view_more_btn {
      background: transparent !important;
      border: 1.5px solid var(--malancha-plum) !important;
      color: var(--malancha-plum) !important;
      border-radius: var(--radius-pill) !important;
    ...
    .sale-badge-box {
      background: var(--malancha-plum) !important;
      border: 1px solid var(--malancha-rosegold) !important;
      border-radius: 0 var(--radius-smooth) 0 var(--radius-smooth) !important;
    }

    /* Hot Deal Timer Fix */
    .offer_timer {
      background: var(--malancha-mauve) !important;
      border: 1px dashed var(--malancha-rosegold) !important;
      color: var(--malancha-plum) !important;
    }
    ...
    @media (max-width: 575px) {
      .section-title-name { font-size: 22px; }
      .pro_name a { font-size: 13px !important; height: 36px; }
    ...
    <body class="gotop">
                        ...
                        <div class="col-sm-3 mb-3 mb-sm-0 d sm-none">
                            <div class="footer-menu">
                                ...
                                <div class="d_app">
                                    <h2>Download App</h2>
                                    <a href="#">
                                        <img src="{{asset('assets/frontEnd/images/app-download.png')}}" alt="" />
                                    </a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="footer-bottom">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="copyright">
                                <p>Copyright © {{ date('Y') }} {{$generalsetting->name}}. All rights reserved | <span style="color: white;">Website Designed by: <a href="#"><span style="color: white;">Bohisojja</span></a></span></p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <script src="{{asset('assets/frontEnd/js/wsit-menu.js')}}"></script>
        <script src="{{asset('assets/frontEnd/js/mobile-menu-init.js')}}"></script>
        ...
        <script src="{{asset('assets/backEnd/')}}/assets/js/toastr.min.js"></script>
        ...
        <!--search ANIMAtion-->
        <script>
            const texts1 = ['Search for Product…','Search for other…','One more search'];
            ...
            const texts = ['Search for Product…','Search for other…','One more search'];
