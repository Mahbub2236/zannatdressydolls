...
<link href="{{asset('assets/backEnd')}}/assets/libs/flatpickr/flatpickr.min.css" rel="stylesheet" type="text/css" />
@endsection
@section('content')
...
<script src="{{asset('assets/backEnd/')}}/assets/libs/flatpickr/flatpickr.min.js"></script>
<script src="{{asset('assets/backEnd/')}}/assets/js/pages/form-pickers.init.js"></script>
