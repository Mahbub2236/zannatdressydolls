...
<link href="{{asset('assets/backEnd/')}}/assets/libs/selectize/css/selectize.bootstrap3.css" rel="stylesheet" type="text/css" />
...
@section('script')
 <!-- Plugins js-->
        ...
        <script src="{{asset('assets/backEnd/')}}/assets/libs/selectize/js/standalone/selectize.min.js"></script>
