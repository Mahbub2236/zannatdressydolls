...
<link href="{{asset('assets/backEnd')}}/assets/libs/summernote/summernote-lite.min.css" rel="stylesheet" type="text/css" />
        ...
        <div class="page-title-box">
            <div class="page-title-right">
                <div class="d-flex align-items-center gap-2">
                    ...
                    <a href="{{route('products.index')}}" class="btn btn-primary rounded-pill px-3">
                        <i class="fa fa-list"></i> Manage
                    </a>

                    <form action="{{ route('products.bulk-upload') }}" method="POST" enctype="multipart/form-data" class="m-0">
                        @csrf
                        <div class="input-group">
                            <input type="file" name="csv_file" class="form-control" style="max-width: 200px;" required>
                            <div class="input-group-append">
                                <button class="btn btn-info" type="submit" style="border-radius: 0 50px 50px 0;">
...
<script src="{{asset('assets/backEnd/')}}/assets/libs/parsleyjs/parsley.min.js"></script>
<script src="{{asset('assets/backEnd/')}}/assets/js/pages/form-validation.init.js"></script>
...
<!-- Plugins js -->
<script src="{{asset('assets/backEnd/')}}/assets/libs//summernote/summernote-lite.min.js"></script>
<script>
