...
<link href="{{asset('assets/backEnd')}}/assets/css/switchery.min.css" rel="stylesheet" type="text/css" />
...
<script src="{{asset('assets/backEnd/')}}/assets/js/switchery.min.js"></script>
<script>
