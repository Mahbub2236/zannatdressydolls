...
<html lang="en">
  <head>
    ...
    <!-- custom css -->
    <link href="{{asset('assets/backEnd/')}}/assets/css/custom.css" rel="stylesheet" type="text/css" />
    <!-- Head js -->
    @yield('css')
    <script src="{{asset('assets/backEnd/')}}/assets/js/head.js"></script>
  </head>
  ...
  <body data-layout-mode="default" data-theme="light" data-layout-width="fluid" data-topbar-color="dark" data-menu-position="fixed" data-leftbar-color="light" data-leftbar-size="default" data-sidebar-user="false">
    ...
    <div id="wrapper">
      ...
      <div class="left-side-menu">
        <div class="h-100" data-simplebar>
          ...
          <div class="user-box text-center">
            <img src="{{asset('assets/backEnd/')}}/assets/images/users/user-1.jpg" alt="user-img" title="Mat Helme" class="rounded-circle avatar-md" />
            <div class="dropdown">
      ...
      <div class="content-page">
        ...
        <footer class="footer">
          <div class="container-fluid">
            <div class="row">
              <div class="col-md-12 text-end"><a href="#" target="_blank">Website Designed by: Bohisojja</a></div>
            </div>
          </div>
        </footer>
        <!-- end Footer -->
    ...
    <!-- Vendor js -->
    <script src="{{asset('assets/backEnd/')}}/assets/js/vendor.min.js"></script>
