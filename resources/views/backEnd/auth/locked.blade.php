...
<head>
        ...
        <!-- App css -->
        <link href="{{asset('assets/backEnd/')}}/assets/css/app.min.css" rel="stylesheet" type="text/css" id="app-style"/>
        <!-- icons -->
                                ...
                                <div class="text-center w-75 m-auto">
                                    <div class="auth-logo">
                                        <a href="index.html" class="logo logo-dark text-center">
                                            <span class="logo-lg">
                                                <img src="{{asset('assets/backEnd/')}}/assets/images/logo-dark.png" alt="" height="22">
                                            </span>
                                        </a>
                    
                                        <a href="" class="logo logo-light text-center">
                                            <span class="logo-lg">
                                                <img src="{{asset('assets/backEnd/')}}/assets/images/logo-light.png" alt="" height="22">
                                            </span>
                                        </a>
                                    </div>
